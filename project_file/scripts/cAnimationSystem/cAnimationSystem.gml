...
// AnimIndex += currentAnimation.animSpd;

// if ( floor( AnimIndex ) >= sprite_get_number( currentAnimation.sprite ) ) {
...
//     && is_undefined( currentAnimation.animEndIndex ) ) {
//         currentAnimation.animEndFunc();
//     }
...
// if ( !is_undefined( currentAnimation.animEndFunc ) 
// && !is_undefined( currentAnimation.animEndIndex ) ) {
//     if ( floor( currentAnimation.animIndex ) >= sprite_get_number( currentAnimation.sprite ) ) {
//     	currentAnimation.animEndFunc();
//     }
// }
        
// AnimIndex = clamp( AnimIndex, 0, sprite_get_number( currentAnimation.sprite ) );
